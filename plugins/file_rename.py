...
from helper.utils import progress_for_pyrogram, humanbytes, convert, semaphore  # <-- Import semaphore here
...
async def auto_rename_files(client, message):
    ...
    # Not in sequence: launch concurrent task, controlled by semaphore from utils.py!
...
# ... (patterns and helper functions remain unchanged) ...
